// tests/fetchPaywall.test.ts
//
// Unit tests for src/app/_api/fetchPaywall.ts's deps-injectable
// functions (canReadPaywall, resolvePaywallBlocks), using fakes so no
// database is required — same pattern as fetchProduct.test.ts /
// layoutRelationsAdapter.test.ts.

import { describe, expect, it } from 'vitest'

import { canReadPaywall, resolvePaywallBlocks } from '../src/app/_api/fetchPaywall'
